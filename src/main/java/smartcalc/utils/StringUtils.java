...
public class StringUtils {
    ...
    public static String optimizeElementsDistribution(String input) {
        return input.replaceAll(OPERATORS, " $0 ")
                    .replaceAll(BRACKETS, " $0 ")
                    .replaceAll(ADDITIONAL_SPACES, " ")
                    .trim();
    }

    public static String[] getAssignmentElements(String input) {
